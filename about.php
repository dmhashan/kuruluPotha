...
<html lang="en" class="no-js">
    ...
    <body onload="countLoad()">
        ...
        <main class="cd-main-content">
            ...
            <center>
                <br><br><br><br>
                <p style="font-size: 45px">We are Uva Wellassa University Computer Science And Technology degree program undergraduates. We did this system for our group project subject in 2017</p>
                <br><br>
                <div style="margin-left: 140px">
                    <div style="display: block; margin:40px;  float: left">
                        <img style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%" src="img/index/15401165_10208257752667070_1571060430728502147_n.jpg">
                        <br><br><h1 style="font-size: 30px">UWU/CST/14/0014</h1>
                        <h1 style="font-size: 24px">D. M. H. Hirosh</h1>
                        <h1 style="font-size: 24px">dmhashan@gmail.com</h1>

                    </div>
                    <div style="display: block; margin:40px;  float: left">
                        <img style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%" src="img/index/11923261_10208114052074747_8893009591054376319_n.jpg">
                        <br><br><h1 style="font-size: 30px">UWU/CST/14/0031</h1>
                        <h1 style="font-size: 24px">PERERA M.I.U.</h1>
                        <h1 style="font-size: 24px">imeshuperera@gmail.com</h1>

                    </div>
                    <div style="display: block; margin:40px;  float: left">
                        <img style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%" src="img/index/18268560_1040240259442745_4192326645881030110_n.jpg">
                        <br><br><h1 style="font-size: 30px">UWU/CST/14/0047</h1>
                        <h1 style="font-size: 24px">WIJESINGHA M.U.M.G.C.P.K.</h1>
                        <h1 style="font-size: 24px">gayan.mnc@gmail.com</h1>

                    </div>
                </div>
                <br><br><br><br><br><br>
                <p style="font-size: 50px">Name of the Supervisors</p>
                <br><br>
                <div style="margin-left: 350px">
                    <div style="display: block; margin:40px;  float: left">
                        <img style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%" src="img/index/13307331_1749722298644561_5007578080621709398_n.jpg">
                        <br><br><h1 style="font-size: 30px">Ms. M. Ramashini</h1>
                        <h1 style="font-size: 24px">Lecturer (Probationary)</h1>
                        <h1 style="font-size: 24px">B-Tech (Anna ,India)</h1>
                        <h1 style="font-size: 24px">ME (Anna ,India)</h1>

                    </div>
                    <div style="display: block; margin:40px;  float: left">
                        <img style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%" src="img/index/IMG_20150511_223103[1].jpg">
                        <br><br><h1 style="font-size: 30px">Ms. D.P. Jayathunga</h1>
                        <h1 style="font-size: 24px">Lecturer (Temporary)</h1>
                        <h1 style="font-size: 24px">BSc (Uva Wellassa)</h1>
