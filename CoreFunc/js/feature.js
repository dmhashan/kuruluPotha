...
function searchName() {
    ...
    if (searchkey !== "" && validateSearchForm()) {
        ...
        xmlhttp.open("GET", "php/feature_submit.php?searchKey=" + searchkey + "&engCheck=" + checkCheckbox1 + "&sciCheck=" + checkCheckbox2 + "&sinCheck=" + checkCheckbox3, true);
        xmlhttp.send();
    }
...
function displayBirds() {
    ...
    xmlhttp.open("GET", "php/feature_submit.php?fistLoad=1", true);
    xmlhttp.send();
    ...
    if (slide === '1') {
        ...
        //alert('nav_describe');
        document.getElementById("nav_location").click();
    }
}
...
function identifyBirdsAjax() {
    ...
    xmlhttp.open("GET", "php/feature_submit.php?birdSize=" + sizeIndex + "&birdShape=" + shapeIndex + "&birdColor=" + colorIndex + "&birdLocation=" + locationIndex, true);
    xmlhttp.send();
}
...
function describeAjax() {
    ...
    xmlhttp.open("GET", "php/feature_submit.php?describeText=" + describeTextArea, true);
    xmlhttp.send();
}
