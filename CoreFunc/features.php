...
<html lang="en" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="css/slideshow.css"> <!-- Resource slideshow -->
        <link rel="stylesheet" href="css/birdbox.css"> <!-- Resource birdbox -->
        <link rel="stylesheet" href="css/hhdbootstrap.css"> <!-- Resource hhdbootstrap -->
    ...
    <body onload="displayBirds()">
        ...
        <main class="cd-main-content">
            <div class="hhdselect">
                <div id="birdSize" class="overlay">
                    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                    <div class="overlay-content">
                        <center>
                            <br>
                            <div class="sizebtn" onclick="selectSizeIndex(1)"><img src="../img/birds/size/S.png" alt="Small">Small</div>
                            <div class="sizebtn" onclick="selectSizeIndex(2)"><img src="../img/birds/size/M.png" alt="Small">Medium</div>
                            <div class="sizebtn" onclick="selectSizeIndex(3)"><img src="../img/birds/size/L.png" alt="Small">Large</div>
                            <br><br>
                            <button class="modalButton" onclick="selectSizeIndex(0)"> None of the above </button>
                            <button class="modalButtonclose" onclick="closeNav()"> Close window </button>
                            <br><br><br>
                        </center>
                    </div>
                </div>
                <div id="birdShape" class="overlay">
                    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                    <div class="overlay-content">
                        <center>
                            <?php
                            require('../CommonFiles/dbConn.php');
                            $sql_shape_load = "SELECT * FROM shape";
                            $result_shape_load = mysqli_query($conn, $sql_shape_load);
                            if (mysqli_num_rows($result_shape_load) > 0) {
                                while ($row_shape_load = mysqli_fetch_assoc($result_shape_load)) {
                                    //echo " <div class = 'sizebtn' onclick='selectShapeIndex(" . $row_shape_load['shapeid'] . ")'><img src = '../img/birds/shape/" . $row_shape_load['shapeimage'] . "' alt = '" . $row_shape_load['shapename'] . "'>" . $row_shape_load['shapename'] . "</div> ";
                                    $shape_name = $row_shape_load['shapename'];
                                    $shape_img = $row_shape_load['shapeimage'];
                                    echo " <div class = 'sizebtn' onclick='selectShapeIndex(" . $row_shape_load['shapeid'] . ",\"$shape_name\",\"$shape_img\")'><img src = '../img/birds/shape/" . $row_shape_load['shapeimage'] . "' alt = '" . $row_shape_load['shapename'] . "'>" . $row_shape_load['shapename'] . "</div> ";
                                }
                            }
                            ?>
                            <br><br>
                            <button class="modalButton" onclick="selectShapeIndex(0)">None of the above</button>
                            <button class="modalButtonclose" onclick="closeNav()"> Close window </button>
                            <br><br><br>
                        </center>
                    </div>
                </div>
                <div id="birdColor" class="overlay">
                    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                    <div class="overlay-content" id="colorPickModal">
                        <center>
                            <?php
                            $sql_color_load = "SELECT * FROM color";
                            $result_color_load = mysqli_query($conn, $sql_color_load);
                            if (mysqli_num_rows($result_color_load) > 0) {
                                while ($row_color_load = mysqli_fetch_assoc($result_color_load)) {
                                    $localColorCode = $row_color_load['colorcode'];
                                    echo " <div id='colorbox-" . $row_color_load['colorid'] . "' class = 'sizebtn' style='width:15%' onclick='selectColorIndex(" . $row_color_load['colorid'] . ",\"$localColorCode\")'> <div id='color-" . $row_color_load['colorid'] . "' class = 'colorCir' style='background: " . $row_color_load['colorcode'] . "' ></div> " . $row_color_load['colorname'] . "</div> ";
                                }
                            }
                            ?>
                            <br><br>
                            <button class="modalButton" onclick="selectColorIndex(0)">None of the above</button>
                            <button class="modalButtonclose" onclick="closeNav()"> Close window </button>
                            <br><br><br>
                        </center>
                    </div>
                </div>
                <div id="birdLocation" class="overlay">
                    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                    <div class="overlay-content">
                        <center>
                            <div style=" top:-38px ; position:relative; width: 18%; float: left; left: 8vw">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.8 36">
                                <style>
                                    .amap { stroke: #adadad; stroke-width: 0.05; } 
                                    .aregion { fill: #fff; cursor: pointer; } 
                                    .aregion:hover, .region.is-active { fill: #69aa6f }
                                    .aborders { fill: none;}
                                </style>
                                ...
                                <!--Ampara-->
                                <g class="aregion" id="adis-1" onclick="mapClick(1)">
                                ...
                                <!--Kurunegala-->
                                <g  class="aregion" id="adis-13" onclick="mapClick(13)">
                                <path d="M8.55 21.52c0 .15-.25.25-.33.35-.08.1-.23-.06-.32-.08-.2-.06-.1.57-.54.4-.15-.32-.6-.53-.64-.05-.05.4-.5.52-.86.64-.2.07-.28.4-.5.25-.12-.08-.15-.18-.28-.26-.13-.07-.05-.26-.22-.28-.2 0-.36.16-.5.26-.27.18-.3 0-.56-.03-.18-.03-.32.15-.5.15-.26-.32-.1-.9-.22-1.28-.15-.42-.23-.92-.15-1.36.03-.2.2-.88.4-.77.15.07.05-.2 0-.25-.16-.13.1-.2.2-.27.2-.17.07-.66.2-.75.24-.15.55-.66.7-.9l.3-.28c.1-.07.33.1.35-.08.02-.18-.16-.17 0-.36.1-.14-.02-.43 0-.6 0-.15-.2-.2-.28-.3-.12-.15-.13-.66-.14-.86.36.35 1 .4 1.46.6.35.16.6.55.97.63.43.1.25.42.33.77.03.13.2.08.3.16.13.14.18.4.2.6 0 .14-.07.3-.03.44.02.08.07.13.16.14-.04.1-.04.17 0 .26.16.3.36.56.5.88.17.45-.18 1.02.04 1.4.22.4-.05.5-.05.8 0 .12 0 0 0 0z"/>
                                <title>Kurunegala</title>
                                </g>

                                <!--Mannar-->
                                <g class="aregion" id="adis-14" onclick="mapClick(14)">
                                ...
                                <!--Ratnapura-->
                                <g class="aregion" id="adis-22" onclick="mapClick(22)">
                                <path d="M10.66 27.3c.63-.07.4.15.2.53-.13.23.04.46.3.46.12-.02.37-.35.47-.3 0 0-.43 1.05-.46 1.16-.1.28-.34.45-.3.77.06.33-.04.75.26.97.2.14 1 1.22.38 1.06-.12-.04-.23-.04-.3-.17-.1-.2-.4-.08-.57-.1-.2-.03-.4-.05-.56-.14-.2-.1-.4-.1-.6-.17.14-.16.08-.58-.17-.47-.05.02-.38.1-.2-.04.1-.1-.13-.1-.1-.2 0-.1.15-.18-.08-.16-.24.03-.5.03-.67.2-.1.07-.83-.13-1-.24-.3-.2-.33-.47-.54-.8-.13-.2-.46-.48-.3-.6.15-.12-.18-.37-.24-.4-.24-.13-.17-.35-.34-.53-.26-.3-.45-.75-.5-1.14.22.03.15-.2.1-.3-.06-.2.13-.5 0-.6-.1-.13 0-.38.17-.34.16.02.33.46.45.6.13.12.25.46.37.54.12.08.38-.16.47-.22.42-.28.75.34 1.12.13.04.18 0 .47.26.47.25 0 .87.2 1.07.12.24-.1.44 0 .68-.05.22-.06.43-.1.63-.1.1-.02-.04 0 0 0z"/>
                                <title>Ratnapura</title>
                                </g>

                                <!--Trincomalee-->
                                <g class="aregion" id="adis-23" onclick="mapClick(23)">
                            ...
                            <?php
                            $sql_location_load = "SELECT * FROM location";
                            $result_location_load = mysqli_query($conn, $sql_location_load);
                            if (mysqli_num_rows($result_location_load) > 0) {
                                while ($row_location_load = mysqli_fetch_assoc($result_location_load)) {
                                    $localLocName = $row_location_load['locationname'];
                                    echo " <div id='loc-" . $row_location_load['locationid'] . "' class = 'sizebtn' style='color:white; font-size:3vh; width:14%' onclick='selectLocationIndex(" . $row_location_load['locationid'] . ",\"$localLocName\")'> " . $row_location_load['locationname'] . "</div> ";
                                }
                            }
                            ?>
                            <br><br>
                            <button class="modalButton" onclick="selectLocationIndex(0)">None of the above</button>
                            <button class="modalButtonclose" onclick="closeNav()"> Close window </button>
                            <br><br><br>
                        </center>
                    </div>
            ...
            <!--Slideshow-->
            <section class="hhdslide">
                <ul class="cd-hero-slider autoplay">
                    <li class="selected">
                        <div class="cd-half-width">
                            <div class="hhdform">
                                <h2>Search Bird by Name</h2>
                                <div name="hhdSearch">
                                    <input type="search" name="searchkey" id="searchkey" placeholder="Search..." required autocomplete="false"/>
                                    <br><br>
                                    <p id="filterP">
                                        <label onclick="return(validateSearchForm())">
                                            <input type="checkbox" name="searchFilter[]" id="searchFiltereng" value="commonname" checked="checked">
                                            English Name</label>
                                        <label onclick="return(validateSearchForm())">
                                            <input type="checkbox" name="searchFilter[]" id="searchFiltersci" value="scientificname">
                                            Scientific Name</label>
                                        <label onclick="return(validateSearchForm())">
                                            <input type="checkbox" name="searchFilter[]" id="searchFiltersin" value="sinhalaname">
                                            සිංහල නම</label>
                                    </p>
                    ...
                    <li>
                        <div class="cd-half-width">
                            <div class="hhdform" id="indentifyForm">
                                <h2>Identify bird ...</h2>
                                <button class="dropbtn" onclick="openBirdSize()" id="sizebutton"><div id="tumbSize" class="tumbSize"></div><div class="dropbtn-cap">Size</div>- None -</button>
                                <button class="dropbtn" onclick="openBirdShape()" id="shapebutton"><div id="tumbShape" class="tumbShape"></div><div class="dropbtn-cap">Shape</div>- None -</button>
                                <button class="dropbtn" onclick="openBirdColor()" id="colorbutton">
                                    <div id="tumbColor" class="tumbColor"></div><div class="dropbtn-cap">Colors</div>
                                    - None -
                                </button>
                                <button class="dropbtn" onclick="openBirdLocation()" id="locationbutton"><div id="tumbLocation" class="tumbLocation"></div><div class="dropbtn-cap">Location</div>- None -</button>
                                <br><br><br>
                            </div>
                        </div> <!-- .cd-half-width -->

                        <!--div class="cd-half-width cd-img-container">
                            <p>To identify an unfamiliar bird, focus first on four keys to identification.</p>
                    ...
                    <li>
                        <div class="cd-half-width">
                            ...
                            <div class="hhdform">
                                <h2>Tell me ...</h2>
                                <textarea id="describeTextArea" placeholder="Describe yourself here which special characteristics that bird have" rows="4" cols="50" style="resize: none"></textarea>
                                <!--input type="search" name="searchkey" id="searchkey" placeholder="Search..." required autocomplete="false"/-->
                                <br><br>
                                <button onclick="describeAjax()">Let's Go</button>
                                <br><br>
                            </div>
                        </div> <!-- .cd-half-width -->
                ...
                <div class="cd-slider-nav" id="slider_nav">
                    <nav>
                        <span class="cd-marker item-1"></span>

                        <ul>
                            <li class="selected"><a href="#0" id="nav_search">Search</a></li>
                            <li><a href="#0" id="nav_identify">Identify</a></li>
                            <li><a href="#0" id="nav_describe">Describe Me</a></li>
                            <?php
                            if (isset($_SESSION["userid"])) {
                                echo '<li><a href="#0" id="nav_location">Location Suggestion</a></li>';
                            }
                            ?>
                        </ul>
                    </nav> 
            ...
            <script src='js/slideshow.main.js'></script>
            <!--Bird Box Area-->

            <section class="hhdbirdbox" id="birdDispaly">

            </section>
            <script src="js/birdbox-main.js"></script> 
