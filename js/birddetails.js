...
function ajaxBirdDetails() {
    ...
    xmlhttp.open("GET", "birddetails_load.php?birdid=" + bird_id, true);
    xmlhttp.send();
}
...
function addCheckList(userid, birdid) {
    ...
    xmlhttp.open("GET", "checkListAddRemove.php?checkType=add&userid=" + userid + "&birdid=" + birdid, true);
    xmlhttp.send();
}
...
function removeCheckList(userid, birdid) {
    ...
    xmlhttp.open("GET", "checkListAddRemove.php?checkType=remove&userid=" + userid + "&birdid=" + birdid, true);
    xmlhttp.send();
}
