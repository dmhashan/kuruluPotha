...
function preEmailFunction()
{
    ...
    if (!preEmail.value.match(regexName) || preEmail.value === "") {
        ...
        xmlhttp.open("GET", "CoreFunc/php/loginEmailUnCheck.php?preEmail=" + preEmail.value, true);
        xmlhttp.send();
    }
}
...
function preUsernameFunction()
{
    ...
    if (!preUsername.value.match(regexUN) || preUsername.value === "") {
        ...
        xmlhttp.open("GET", "CoreFunc/php/loginEmailUnCheck.php?preUsername=" + preUsername.value, true);
        xmlhttp.send();
    }
}
